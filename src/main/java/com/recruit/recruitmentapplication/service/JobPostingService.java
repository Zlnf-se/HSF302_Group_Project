...
public class JobPostingService {
    ...
    @Transactional(readOnly = true)
    public List<JobPosting> findOpenJobs(String keyword, String department, String location) {
        return jobPostingRepository.findOpenJobsWithCompanyAndFilters(
                normalizeFilter(keyword), normalizeFilter(department), normalizeFilter(location));
    }

    @Transactional(readOnly = true)
    public List<String> findOpenDepartments() {
        return jobPostingRepository.findOpenDepartments();
    }

    @Transactional(readOnly = true)
    public List<String> findOpenLocations() {
        return jobPostingRepository.findOpenLocations();
    }
