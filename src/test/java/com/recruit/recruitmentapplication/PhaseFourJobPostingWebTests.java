...
class PhaseFourJobPostingWebTests {
    ...
    @Test
    void anonymousAndCandidateCanReadPublicJobs() throws Exception {
        ...
        mockMvc.perform(get("/jobs"))
                ...
                .andExpect(content().string(containsString("Login or create an account to apply for positions.")));
        mockMvc.perform(get("/jobs").session(session(Role.CANDIDATE)))
                ...
                .andExpect(content().string(not(containsString("Create New Job"))));
